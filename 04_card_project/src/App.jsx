  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(element){
        return <Card company={element.companyName} post={element.post} tag1={element.tag1} tag2 = {element.tag2} pay={element.pay} brandLogo={element.brandLogo} datePosted={element.datePosted} location={element.location}  />
      })}
    </div>
  )
}
